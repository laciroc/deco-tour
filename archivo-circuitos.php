...
<html lang="es">
  <head>
    ...
    <title>Circuitos Must | Archivo | Deco Tour</title>
  ...
  <body class="container-fluid">
    ...
    <div>
      <h1 class="hide">Deco Tour - Circuitos Must</h1>
        ...
        <div  class="col-md-9 col-sm-9 col-lg-7 col-lg-offset-1">
          ...
          <ol class="breadcrumb hidden-xs">
            ...
            <li class="active"><a href="#">Circuitos Must</a></li>
          ...
          <!-- circuito -->
            <p>Directo desde nuestro blog te mostramos las tiendas que más nos gustan y los productos destacados. Es importante aclarar que esta sección está basada sólo en gustos y criterios personales, queremos compartir lo que encontramos novedoso, lo que nos genera algo especial, no existe nada pago en esta sección, eso lo dejamos destinado a los sectores de banners publicitarios y tiendas destacadas.</p>

              <div class=" col-xs-12 fondo-verde circuitoListado">
                <a href="circuitos-must.php"><h3 class="nombreCircuito" class="tituloVerde">Lomas de Zamora - Parte 1</h3></a> <!-- NOMBRE DEL CIRCUITO -->
                <p class="introCircuito">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <a href="circuitos-must.php">Ver m&aacute;s.</a></p>              
              </div>
          ...
          <section id="cajaNotasInteres" class="col-md-6 col-sm-7 col-xs-12 margentop-30">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <ul id="notasInteres1">
                <a href="circuito-must-tienda.php"><li><img src="images/attachment.png" class="pull-left"><p class="tituloNotaHome">Tienda de la semana</p><p class="subtituloNotaHome">adipisicing consectetur elit</p></li></a>
                <a href="circuito-must-tienda.php"><li><img src="images/attachment.png" class="pull-left"><p class="tituloNotaHome">Tienda de la semana</p><p class="subtituloNotaHome">adipisicing consectetur elit</p></li></a>
              </ul>
            </div>
