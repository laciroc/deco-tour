  ...
  <body class="container-fluid">
    ...
    <div>
        ...
        <div  class="col-md-9 col-sm-9 col-lg-7 col-lg-offset-1">
          ...
          <h1 class="text-center fuente-50">Mobiliario</h1>  <!-- NOMBRE DE CATEGORIA -->

          <!-- breadcrumbs -->
          <ol class="breadcrumb hidden-xs">
            <li><a href="index.php">Inicio</a></li>
            <li class="active">Mobiliario</li> <!-- NOMBRE DE CATEGORIA -->
         ...
         <!-- caja tiendas en categoria VIENE DE QUERY -->
