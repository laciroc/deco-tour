...
<html lang="es">
  <head>
    ...
    <title>Recomendar Tienda | Deco Tour </title>
    <!-- Bootstrap -->
  ...
  <body class="container-fluid">
    ...
    <div>
        ...
        <div  class="col-md-9 col-sm-9 col-lg-7 col-lg-offset-1">
          ...
          <h1 class="text-center fuente-50">Recomend&aacute; una tienda</h1>

          <!-- breadcrumbs -->
          <ol class="breadcrumb hidden-xs">
            <li><a href="index.php">Inicio</a></li>
            <li class="active">Recomendar tienda</li> 
          </ol>
          <!-- fin breadcrumbs -->
          ...
          <div class="fondo-verde caja-informativa">
            ...
            <p class="margentop-10">Te invitamos a sumarte y  que nos recomiendes tiendas que te gusten para que juntos creemos el primer circuito de diseño de Argentina.</p>  

           <!-- FORMULARIO --> 
            <form class="form-inline formulario">
              <div class="form-group col-xs-12">
                  <label for="nombre_tienda_recomendada" class="col-xs-12 col-sm-6 col-md-4" >Nombre</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="nombre_tienda_recomendada"
                         placeholder="Nombre de la tienda que quer&eacute;s recomendar">
              </div>
              
              <div class="form-group col-xs-12">
                  <label for="rubro_tienda_recomendada" class="col-xs-12 col-sm-6 col-md-4">Rubro</label>
                  <input type="text" class=" col-xs-12 col-sm-6 col-md-6" id="rubro_tienda_recomendada"
                         placeholder="De qu&eacute; se tratan sus productos">
              </div>

              <div class="form-group col-xs-12">
                  <label for="direccion_tienda_recomendada" class="col-xs-12 col-sm-6 col-md-4">Direcci&oacute;n</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="direccion_tienda_recomendada" 
                         placeholder="Calle y n&uacute;mero">
               </div>

              <div class="form-group col-xs-12">           
                  <label for="localidad_tienda_recomendada" class="col-xs-12 col-sm-6 col-md-4">Localidad</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="localidad_tienda_recomendada" 
                         placeholder="Localidad">       
              </div>

              <div class="form-group col-xs-12">
                  <label for="nombre_recomedador" class="col-xs-12 col-sm-6 col-md-4">Tu nombre</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="nombre_recomedador" placeholder="Tu nombre">
              </div>

              <div class="form-group col-xs-12">    
                  <label for="mail_recomedador" class="col-xs-12 col-sm-6 col-md-4">Tu mail</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="mail_recomedador" placeholder="Tu mail">
              </div>
              
              <div class="form-group col-xs-12">    
                  <label for="mensaje_recomedacion" class="col-xs-12 col-sm-6 col-md-4">Mensaje</label>
                  <textarea class="col-xs-12 col-sm-6 col-md-6" id="mensaje_recomedacion" placeholder="Contanos por qu&eacute; recomend&aacute;s esta tienda"></textarea>
              </div>
