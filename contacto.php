...
<html lang="es">
  <head>
    ...
    <title>Contacto | Deco Tour </title>
    <!-- Bootstrap -->
  ...
  <body class="container-fluid">
    ...
    <div>
        ...
        <div  class="col-md-9 col-sm-9 col-lg-7 col-lg-offset-1">
          ...
          <h1 class="text-center fuente-50">Contacto</h1>
          ...
          <div class="fondo-verde caja-informativa">
            ...
            <p class="margentop-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>  
           ...
           <!-- FORMULARIO --> 
            <form class="form-inline formulario">
              ...
              <div class="form-group col-xs-12">    
                  ...
                  <textarea class="col-xs-12 col-sm-6 col-md-6" id="mensaje_recomedacion" placeholder=""></textarea>
              </div>
