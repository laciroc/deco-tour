...
<html lang="es">
  <head>
    ...
    <title>Publicitar mi Negocio | Deco Tour </title>
    <!-- Bootstrap -->
  ...
  <body class="container-fluid">
    ...
    <div>
        ...
        <div  class="col-md-9 col-sm-9 col-lg-7 col-lg-offset-1">
          ...
          <h1 class="text-center fuente-50">Publicit&aacute; tu negocio</h1>

          <!-- breadcrumbs -->
          <ol class="breadcrumb hidden-xs">
            <li><a href="index.php">Inicio</a></li>
            <li class="active">Publicitar mi negocio</li> 
          </ol>
          <!-- fin breadcrumbs -->
          ...
          <div class="fondo-verde caja-informativa">
            ...
            <p class="margentop-10">Si estás interesado en publicitar tu negocio como tienda destacada o en banners, mandanos tu info para que podamos enviarte nuestro pack multimedia, hay para todos los gustos y medidas!</p>  

           <!-- FORMULARIO --> 
            <form class="form-inline formulario">
              <div class="form-group col-xs-12">
                  <label for="nombre_tienda_publicitar" class="col-xs-12 col-sm-6 col-md-4" >Nombre</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="nombre_tienda_publicitar"
                         placeholder="Nombre de la tienda">
              </div>
              
              <div class="form-group col-xs-12">
                  <label for="rubro_tienda_publicitar" class="col-xs-12 col-sm-6 col-md-4">Rubro</label>
                  <input type="text" class=" col-xs-12 col-sm-6 col-md-6" id="rubro_tienda_publicitar"
                         placeholder="De qu&eacute; se tratan sus productos">
              </div>

              <div class="form-group col-xs-12">
                  <label for="nombre_publicitar" class="col-xs-12 col-sm-6 col-md-4">Tu nombre</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="nombre_publicitar" placeholder="Tu nombre">
              </div>

              <div class="form-group col-xs-12">    
                  <label for="mail_publicitar" class="col-xs-12 col-sm-6 col-md-4">Tu mail</label>
                  <input type="text" class="col-xs-12 col-sm-6 col-md-6" id="mail_publicitar" placeholder="Tu mail">
              </div>
              
              <div class="form-group col-xs-12">    
                  <label for="mensaje_recomedacion" class="col-xs-12 col-sm-6 col-md-4">Mensaje</label>
                  <textarea class="col-xs-12 col-sm-6 col-md-6" id="mensaje_recomedacion" placeholder="Contanos un poco más de tu tienda"></textarea>
              </div>
